...
function Footer() {
  return (
    <footer className="footer-links" style={{ backgroundColor: "rgb(240,240,240)" }}>
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col">
            ...
            <div className="row mt-5">
              <div className="col fs-5 d-flex flex-wrap gap-3">
          ...
          <div className="col">
            ...
            <br /> <a href="">Status of your complaints</a>
            <br/>
            <a href="">Career</a>
            <br />
        ...
        <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
          ...
          <p>
            ...
            consolidated account statement issued by
          </p>
        ...
        {/* <div className="row mt-5 footer-legal-links">
          <div className="col">
            <a href="">NSE</a>
          </div>
          <div className="col">
          ...
          <div className="footer-legal-links mt-4">
  <a href="#">NSE</a>
  <a href="#">BSE</a>
  <a href="#">MCX</a>
  <a href="#">Terms & conditions</a>
