    ...
    <div className="container">
      <div className="row p-5 mb-5">
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          ...
          <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Transfer and Conversion of status</a><br/>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          ...
          <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>ManagingLevrage, Product and Order types</a><br/>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="f">
           <i class="fa fa-window-maximize" aria-hidden="true"></i> Funds </h4>
           <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Adding Funds</a><br/>
          <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Fund Withdraw</a><br/>
          <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>eMandate </a><br/>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          ...
          <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Managinig your Portfolio</a><br/>
