        ...
        <div className='row p-5 mb-5'>
            <h1 className='fs-2 text-center'>We pioneered the discount broking model in India.<br/>
                Now, we are breaking ground with our technology.</h1>
                 ...
                 <div className='row p-5 mb-5 border-top text-muted '
                 style={{lineHeight:"1.8", fontSize:"1.2em"}}>
            
                <div className='col-6 p-5'>
                    <p>We kick-started operations on the 15th of August, 
                    2010 with the goal of breaking all barriers that traders and 
                ...
                <div className='col-6 p-5'>
                    ...
                    <p><a href='#' style={{lineHeight:"1.8", fontSize:"1.2em"}}>Rainmatter</a>, our fintech fund and incubator, has invested in several fintech startups with the goal 
